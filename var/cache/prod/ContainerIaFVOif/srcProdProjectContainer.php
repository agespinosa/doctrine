...
class srcProdProjectContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $c = new \Knp\Bundle\MarkdownBundle\Parser\ParserManager();
        $c->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Min(), 'min');
        $c->addParser(($this->services['markdown.parser'] ?? $this->services['markdown.parser'] = new \Knp\Bundle\MarkdownBundle\Parser\Preset\Light()), 'default');
        $c->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Medium(), 'medium');
        $c->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Max(), 'max');
    ...
    protected function getDebug_DebugHandlersListenerService()
    {
        ...
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, $a, -1, 0, false, ($this->privates['debug.file_link_formatter'] ?? $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)), false);
    }
